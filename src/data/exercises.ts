...
describe('Verificar si es número', () => {
  ...
  test('debe retornar false para no números', () => {
  ...
  test('debe usar toBeTruthy y toBeFalsy', () => {
...
describe('Filtrar números pares', () => {
  test('debe filtrar números pares correctamente', () => {
...
describe('Validar contraseña', () => {
  ...
  test('debe verificar longitud mínima', () => {
...
describe('Crear usuario', () => {
  test('debe crear objeto usuario correctamente', () => {
    const usuario = crearUsuario('Ana', 25, 'ana@email.com');
  ...
  test('debe verificar mayoría de edad correctamente', () => {
    const mayor = crearUsuario('Juan', 20, 'juan@email.com');
    const menor = crearUsuario('Luis', 16, 'luis@email.com');
    
    expect(mayor.esMayorDeEdad).toBeTruthy();
    expect(menor.esMayorDeEdad).toBeFalsy();
  });

  test('debe comparar objetos completos', () => {
    const usuario1 = crearUsuario('María', 30, 'maria@email.com');
    const usuario2 = crearUsuario('María', 30, 'maria@email.com');
    
    // No usar toBe() para objetos
    expect(usuario1).toEqual(usuario2);
  });

  test('debe verificar propiedades numéricas', () => {
    const usuario = crearUsuario('Pedro', 45, 'pedro@email.com');
...
describe('Calcular estadísticas', () => {
  test('debe calcular estadísticas correctamente', () => {
    const stats = calcularEstadisticas([1, 2, 3, 4, 5]);
  ...
  test('debe usar comparaciones numéricas', () => {
    const stats = calcularEstadisticas([10, 20, 30]);
  ...
  test('debe manejar decimales correctamente', () => {
    const stats = calcularEstadisticas([1, 2, 4]);
...
describe('Validador de Email', () => {
  ...
  test('debe verificar longitud del email', () => {
